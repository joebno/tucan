...
color_schemes = %{
  ...
  "four-groups-cat-1" => ["#000000", "#d2d2d2", "#fdbf11", "#71E5D1"],
  "four-groups-cat-2" => ["#71E5D1", "#ec0008b", "#fdbf11", "#5c5859"],
  "four-groups-seq" => ["#cfe8f3", "#73bf42", "#71E5D1", "#0a4c6a"],
  "five-groups-cat-1" => ["#71E5D1", "#fdbf11", "#d2d2d2", "#ec008b", "#000000"],
  "five-groups-cat-2" => ["#71E5D1", "#0a4c6a", "#d2d2d2", "#fdbf11", "#332d2f"],
  "five-groups-seq" => ["#cfe8f3", "#73bf42", "#71E5D1", "#0a4c6a", "#000000"],
  "six-groups-cat-1" => ["#71E5D1", "#ec008b", "#fdbf11", "#000000", "#d2d2d2", "#55b748"],
  "six-groups-cat-2" => ["#71E5D1", "#d2d2d2", "#ec008b", "#fdbf11", "#332d2f", "#0a4c6a"],
